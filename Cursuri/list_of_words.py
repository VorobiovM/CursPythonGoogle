...
LIST_OF_WORDS = ["abruptly", "absurd", "abyss", "affix", "askew", "avenue", "awkward", "axiom", "azure", "bagpipes",
...
def get_random_word():
    rand_id = random.randint(0, len(LIST_OF_WORDS))
    return LIST_OF_WORDS[rand_id]
